...
const TrainingCard: React.FC<TrainingCardProps> = ({
    ...
    return (
        <div
            className={`mb-6 rounded-2xl overflow-hidden border ${borderColor} transition-all duration-300 hover:border-blue-500/50 hover:shadow-lg hover:shadow-blue-500/10 ${isExpanded ? "ring-1 ring-blue-500/30 bg-[#151e32] scale-[1.02]" : "bg-[#111c33] hover:-translate-y-1"
                }`}
        >
            <div
            ...
            >
                ...
                <div className="flex justify-center">
                    <span className={`text-blue-400/40 transform transition-transform duration-200 ${isExpanded ? "rotate-180" : ""}`}>
