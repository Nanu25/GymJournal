...
interface TrainingSelectorProps {
    ...
    onSaveTraining: (training: TrainingEntry) => void;
}
    ...
    const handleSaveTraining = async () => {
        ...
        if (Object.keys(filteredData).length > 0) {
            ...
            try {
                ...
                // Call the parent's onSaveTraining with the saved data
                onSaveTraining(savedTraining);
                ...
                console.error("Error saving training:", error instanceof Error ? error.message : 'Unknown error');
