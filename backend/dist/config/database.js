...
exports.AppDataSource = new typeorm_1.DataSource({
    ...
    synchronize: true,
    logging: true,
    entities: [User_1.User, Training_1.Training, Exercise_1.Exercise, TrainingExercise_1.TrainingExercise, ActivityLog_1.ActivityLog, MonitoredUser_1.MonitoredUser],
    subscribers: [],
    migrations: [],
});
